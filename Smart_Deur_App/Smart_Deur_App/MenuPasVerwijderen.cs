...
namespace Smart_Deur_App
{
    public partial class MenuPasVerwijderen : Form
    {
        ...
        private void MenuPasVerwijderen_FormClosing(object sender, FormClosingEventArgs e)
        {
        ...
        {
            MedewerkersPasVerwijderen medewerkersPasVerwijderen = new MedewerkersPasVerwijderen();
            medewerkersPasVerwijderen.Show();
            this.Hide();
        }

        private void btn_BezoekerPas_Click(object sender, EventArgs e)
        {
            BezoekersPasVerwijderen bezoekersPasVerwijderen = new BezoekersPasVerwijderen();
            bezoekersPasVerwijderen.Show();
            this.Hide();
        }
